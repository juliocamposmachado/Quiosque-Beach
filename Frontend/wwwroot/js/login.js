...
function verificarRetornoGoogle() {
    ...
    if (token && user) {
        try {
            ...
            // Redirecionar para página de instalação se for primeiro login ou não visitou ainda
            setTimeout(() => {
...
// Verificar se deve redirecionar para página de instalação
function shouldRedirectToInstall() {
    ...
    // Não redirecionar se:
    // - Já visitou a página de instalação
    // - Já escolheu pular a instalação
    // - Aplicativo já está instalado (PWA)
